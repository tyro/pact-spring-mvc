...
public interface PactFilter {
    ...
    boolean shouldExcludePact(Class<?> testClazz, Pact pact);

    boolean shouldExcludeInteractionOrWorkflow(Class<?> testClazz, Pact pact, String interactionOrWorkflowId);
}
